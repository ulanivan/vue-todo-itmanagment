<template>
  <div class="add-todo">
    <div class="group">
      <input v-on:keyup.enter="addTodo" v-model="todoTitle" id="note-todo" type="text" required>
      <span class="bar"></span>
      <label for="note-todo">Add</label>
    </div>
    <button @click.prevent="addTodo" class="add-todo-button">
